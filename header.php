...
<head>
  ...
  <title>HOTELES</title>
  <link rel="icon" type="image/png" href="images/icons/distritech.ico" />
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
        ...
        <div class="sidebar-brand-text mx-3">Zona Hotelera <sup></sup></div>
      </a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Hoteles:</h6>
            <a class="collapse-item" href="filtrarClientes.php">Añadir Hotel</a>
